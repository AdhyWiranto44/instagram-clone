...
export default function Explore() {
  return (
    <>
      <div className="mb-10">
        <Navbar />
        <div id="main" className="container mx-auto lg:px-36 xl:px-44 mt-2 p-1">
          <div className="explore_posts">
            <div id="post" className="w-4/12 inline-block p-1 md:p-2 lg:p-4 cursor-pointer -mt-1" onClick={() => console.log("ter-click~")}>
              <img className='hover:border-2 border-black' src='post_2.jpg' />
            </div>
            <div id="post" className="w-4/12 inline-block p-1 md:p-2 lg:p-4 cursor-pointer -mt-1">
